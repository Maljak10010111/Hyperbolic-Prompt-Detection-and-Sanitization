...
class AttackHandler:
    ...
    def execute_attack(
        ...
        if attack_type == AttackType.N1:
            ...
            # print(f"To be added generation shape: {to_be_added_generation_embeddings.shape}")
            # print(f"To be removed generation shape: {to_be_removed_generation_embeddings.shape}")
            # print(f"To be added embedding shape: {to_be_added_embeddings.shape}")
            # print(f"To be removed embedding shape: {to_be_removed_embeddings.shape}")
...
class ImageGenerator:
    ...
    def _generate_single_case(
        ...
        if self.config.attack_type != AttackType.NONE and attack_prompts:
            ...
            print("emb dict:", emb_dict["N1"].shape)
