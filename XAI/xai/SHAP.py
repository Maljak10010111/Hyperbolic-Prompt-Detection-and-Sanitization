"""
    This script computes word-level attributions for malicious prompts of ViSU test dataset using SHAP and a hyperbolic MLR model.
"""
...
output_path = "/data/imaljkovic/Diffusion-Models-Embedding-Space-Defense/XAI/xai/shap_word_attributions.jsonl"
...
with open(output_path, "w", encoding="utf-8") as outf:
    for pair in tqdm(data):
        ...
        try:
            shap_values = explainer.shap_values(np.array([malicious_tokens], dtype=object), nsamples=100)
