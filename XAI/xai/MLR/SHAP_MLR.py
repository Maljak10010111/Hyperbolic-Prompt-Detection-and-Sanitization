"""
    This script computes token and word-level attributions for malicious prompts of ViSU test dataset using SHAP and a hyperbolic MLR model.
"""
...
output_path = "/mnt/data3/imaljkovic/Diffusion-Models-Embedding-Space-Defense/XAI/xai/shap_word_attributions_MLR.jsonl"
mlr_model_path = "/mnt/data3/imaljkovic/Diffusion-Models-Embedding-Space-Defense/models/final_hyperbolic_mlr_model.pth"
...
class FullModel(nn.Module):
    def __init__(self, hyperbolic_clip, mlr, manifold):
        super().__init__()
    ...
    def forward(self, input_ids_tensor):
        ...
        output = self.mlr(embedding)
        return torch.sigmoid(output)


full_model = FullModel(hyperbolic_clip, mlr, manifold)
