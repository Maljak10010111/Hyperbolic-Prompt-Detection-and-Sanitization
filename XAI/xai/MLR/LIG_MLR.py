"""
    This script computes token and word-level attributions for malicious prompts of ViSU test dataset using Layer Integrated Gradients (LIG) with a hyperbolic MLR model.
    Corresponding benign prompts are used as baselines.
"""
