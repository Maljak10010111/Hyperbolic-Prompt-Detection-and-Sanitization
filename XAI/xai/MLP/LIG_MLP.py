"""
    This script computes word-level attributions for malicious prompts of ViSU test dataset using Layer Integrated Gradients (LIG) with a hyperbolic MLP model.
"""
...
output_path = "/mnt/data3/imaljkovic/Diffusion-Models-Embedding-Space-Defense/XAI/xai/lig_word_attributions_MLP.jsonl"
...
mlp = LorentzMLP(manifold=manifold, input_dim=768, hidden_dim=512)
...
lig = LayerIntegratedGradients(
    lambda input_ids: torch.sigmoid(
        mlp(hyperbolic_clip.encode_text(input_ids, project=True))),
        embedding_layer
)
