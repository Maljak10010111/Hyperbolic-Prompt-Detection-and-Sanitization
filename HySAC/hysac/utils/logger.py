class WandbLogger:
    ...
    def log_training_iteration_A_entailment(
        self,
        idx,
        text_safe_loss,
        text_nsfw_loss,
    ...
    def log_training_iteration(
        ...
        vision_safe_loss,
        vision_nsfw_loss,
        S_Vref_contrastive_loss,
        U_Vref_contrastive_loss,
        V_Sref_contrastive_loss,
        G_Sref_contrastive_loss,
        training_loss,
    ):
        self.run.log(
            {
                ...
                "vision_safe_training_loss": vision_safe_loss.mean(),
                "vision_nsfw_training_loss": vision_nsfw_loss.mean(),
                "S_Vref_contrastive_training_loss": S_Vref_contrastive_loss[
                    "loss"
                ].mean(),
                "U_Vref_contrastive_training_loss": U_Vref_contrastive_loss[
                    "loss"
                ].mean(),
                "V_Sref_contrastive_training_loss": V_Sref_contrastive_loss[
                    "loss"
                ].mean(),
                "G_Sref_contrastive_training_loss": G_Sref_contrastive_loss[
                    "loss"
                ].mean(),
                "training_loss": training_loss,
                "batch_id": idx,
    ...
    def log_training_iteration_frozen_clip(self, idx, training_loss):
        self.run.log({"training_loss": training_loss, "batch_id": idx})

    def log_validation_A_entailment(
        self,
        len_validation_dataset,
        text_safe_loss_cumulative,
        text_nsfw_loss_cumulative,
        vision_safe_loss_cumulative,
        vision_nsfw_loss_cumulative,
        entail_A_safe_cumulative,
        entail_A_nsfw_cumulative,
        validation_loss,
        batch_size,
    ):
        self.run.log(
            {
                "text_safe_validation_loss": text_safe_loss_cumulative
                / len_validation_dataset,
                "text_nsfw_validation_loss": text_nsfw_loss_cumulative
                / len_validation_dataset,
                "vision_safe_validation_loss": vision_safe_loss_cumulative
                / len_validation_dataset,
                "vision_nsfw_validation_loss": vision_nsfw_loss_cumulative
                / len_validation_dataset,
                "entail_A_safe_validation_loss": entail_A_safe_cumulative
                / len_validation_dataset,
                "entail_A_nsfw_validation_loss": entail_A_nsfw_cumulative
                / len_validation_dataset,
    ...
    def log_validation(
        ...
        vision_safe_loss_cumulative,
        vision_nsfw_loss_cumulative,
        S_Vref_contrastive_loss_cumulative,
        U_Vref_contrastive_loss_cumulative,
        V_Sref_contrastive_loss_cumulative,
        G_Sref_contrastive_loss_cumulative,
        validation_loss,
        batch_size,
    ):
        self.run.log(
            {
                ...
                "vision_nsfw_validation_loss": vision_nsfw_loss_cumulative
                / len_validation_dataset,
                "S_Vref_contrastive_validation_loss": S_Vref_contrastive_loss_cumulative
                / len_validation_dataset,
                "U_Vref_contrastive_validation_loss": U_Vref_contrastive_loss_cumulative
                / len_validation_dataset,
                "V_Sref_contrastive_validation_loss": V_Sref_contrastive_loss_cumulative
                / len_validation_dataset,
                "G_Sref_contrastive_validation_loss": G_Sref_contrastive_loss_cumulative
                / len_validation_dataset,
                "validation_loss": validation_loss / batch_size,
            }
        )
