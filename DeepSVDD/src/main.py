...
from datasets.visu_benign import VisuTestDataset
...
def main(dataset_name, net_name, xp_path, data_path, load_config, load_model, objective, nu, device, seed,
    ...
    embedding_path = '/src/datasets/embeddings/test_tensors.pt'
    label_path = '/src/datasets/embeddings/test_labels.pt'
    save_path = 'C:/Users/Asus/PycharmProjects/Deep-SVDD-PyTorch/data/'

    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

    test_dataset = VisuTestDataset(path_embeddings=embedding_path, path_labels=label_path)
    ...
    ax.scatter(embeddings_3d[benign, 0], embeddings_3d[benign, 1], embeddings_3d[benign, 2],
               c='blue', label='Benign', alpha=0.6, s=20)
    ax.scatter(embeddings_3d[malicious, 0], embeddings_3d[malicious, 1], embeddings_3d[malicious, 2],
               c='red', label='Malicious', alpha=0.6, s=20)

    ax.set_title('3D UMAP of Test Embeddings')
    ax.legend()
    plt.tight_layout()
